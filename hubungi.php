                            ...
                            <div class="col-md-10">
                                <div class="contact_form_inner">
                                    <div class="contact_field">
                                        <form action="./admineventisbi/superadmin/modul_kontak/proses_simpan.php" method="POST">
                                            <h3>Hubungi Kami</h3>
                                            <hr class="bawah">
                                            <p>Jangan Ragu untuk menghubungi kami kapan saja. Kami akan menghubungi Anda
                                                sesegera mungkin!.</p>
                                            <div class="form-group ">
                                                <input type="text" class="form-control form-group" name="nama" placeholder="Nama" required />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control form-group" name="email" placeholder="Email" required />
                                            </div>
                                            <div class="form-group">
                                                <textarea class="form-control form-group" name="pesan" placeholder="Pesan" required></textarea>
                                            </div>
