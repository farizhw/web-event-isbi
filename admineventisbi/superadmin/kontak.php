                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <?php if ($_SESSION['level']=="SuperAdmin") { ?>
                                ...
                                <li class="active"><a href="#"><i class="far fa-address-book"></i><span>Data Kontak</span></a></li>
                ...
                <table id="mydatatabel" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $data_k=mysqli_query($conn, "SELECT * FROM kontak");
                            $no=1;
                            while ($d=mysqli_fetch_array($data_k)) {
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            ...
                            <td>
                                <a href="./modul_kontak/proses_hapus.php?id_kontak=<?php echo $d['id_kontak']; ?>"
