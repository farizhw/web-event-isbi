...
<body>
    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <?php if ($_SESSION['level']=="SuperAdmin") { ?>
                                ...
                                <li class="active"><a href="#"><i class="fas fa-sliders-h"></i></i><span>Slider</span></a></li>
                            <?php 
                                        }
                                    ?>
                            <!-- UNTUK SUPERADMIN -->
                ...
                <table id="mydatatabel" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th width="1%">NO</th>
                            <th>Jurusan</th>
                            <th>Fakultas / Program Pascasarjana</th>
                            <th>Slider</th>
                            <th width="14%">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                            ...
                            $data_sl=mysqli_query($conn, "SELECT * FROM slider");
                            $no=1;
                            while ($d=mysqli_fetch_array($data_sl)) {
                        ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $d['ket_slider']; ?></td>
                            <td><?php echo $d['kat_slider']; ?></td>
                            <td align="center" width="12%"><?php echo "<img src='../images/$d[nama_slider]'>" ?></td>
                            <td>
                                <a href="./modul_slider/edit_slider.php?id_slider=<?php echo $d['id_slider']; ?>"
                                    class=" btn btn-warning btn-rounded btn-sm">Edit
                                </a> |
                                <a href="./modul_slider/proses_hapus.php?id_slider=<?php echo $d['id_slider']; ?>"
        ...
        <!-- MODAL TAMBAH -->
        <form action="./modul_slider/proses_simpan.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ket_slider" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Fakultas/Program Pascasarjana</label>
                                    <select class="form-control" name="kat_slider" required>
                                        <option value="">-- Pilih --</option>
                                        <option value="Fakultas Seni Pertunjukan">Fakultas Seni Pertunjukan</option>
                                        <option value="Fakultas Seni Rupa dan Desain">Fakultas Seni Rupa dan Desain</option>
                                        <option value="Fakultas Budaya dan Media">Fakultas Budaya dan Media</option>
                                        <option value="Program Pascasarjana">Program Pascasarjana</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Unggah Foto</label>
                                    <input type="file" class="form-control-file" name="slideku">
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="reset" name="reset" class="btn btn-light" data-dismiss="modal"> Batal</button>
