...
include ('../../konfig/koneksi.php');
  ...
  if (isset($_GET['id_kegiatan'])) {
    ...
    $sql = "SELECT * FROM keg WHERE id_kegiatan='$id_kegiatan'";
    ...
    $row = mysqli_fetch_array($hasil);
       if (!count($row)) {
          echo "<script>alert('Data tidak ditemukan pada tabel');window.location='../kegiatan.php';</script>";
       }
  } else {
    echo "<script>alert('Masukkan ID yang ingin di edit.');window.location='../kegiatan.php';</script>";
  }         
?>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#"><i class="far fa-file-alt"></i><span>Data
                                                Kegiatan</span></a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="../kegiatan.php">Data Kegiatan</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Edit Kegitan</h4>
                                    <i style="float: left;font-size: 11px;color: #bec2bf">Dengan ID Kegiatan
                                        <?php echo $_GET['id_kegiatan'] ?>*</i>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="./proses_update.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id_kegiatan"
                                                value="<?php echo $row['id_kegiatan']; ?>" class="form-control">
                                            <input type="text" name="judul_k" value="<?php echo $row['judul_k']; ?>"
                                                class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label>Deskripsi Kegiatan</label>
                                            <textarea class="form-control" name="desk_k"
                                                rows="3"><?php echo $row['desk_k']; ?></textarea>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Tanggal Mulai</label>
                                                <input type="datetime-local" name="tglmulai"
                                                    value="<?php echo $row['tglmulai']; ?>" class="form-control"
                                                    placeholder="Tanggal Mulai">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Tanggal Akhir</label>
                                                <input type="datetime-local" name="tglakhir"
                                                    value="<?php echo $row['tglakhir']; ?>" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                if ($row['jenis_k'] == "Internal") echo "<input type='radio' name='jenis_k' value='Internal' checked> Internal  &nbsp; &nbsp; <input type='radio' name='jenis_k' value='Eksternal'> Eksternal";
                                                else if ($row['jenis_k'] == "Eksternal") echo "<input type='radio' name='jenis_k' value='Internal'> Internal  &nbsp; <input type='radio' name='jenis_k' value='Eksternal' checked> Eksternal";
                                            ?>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-form-label">Kategori Kegiatan</label>
                                            <select class="form-control" name="kategori_k">
                                                <?php 
                                            include '../konfig/koneksi.php';
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Poster</label><br>
                                            <i style="float: left;font-size: 11px;color: red">*Abaikan jika tidak
                                                merubah poster*</i>
                                            <input type="file" class="form-control" name="gambar_k" /><br>
                                            <img src="../../images/<?php echo $row['gambar_k']; ?>" width="100">
                                        </div>
